                        ...
                        <div class="card-body p-3 p-md-4">
                            <div class="row mb-3 align-items-center">
                                ...
                                <div class="col-sm-9 col-md-5">
                                    <input placeholder="Código" required v-model="alumno.codigo" type="text" class="form-control bg-body-tertiary border-0 shadow-sm text-body">
                                </div>
                            </div>
                            <div class="row mb-3 align-items-center">
                            ...
                            <div class="row mb-3 align-items-center">
                                ...
                                <div class="col-sm-9">
                                    <input placeholder="Dirección residencial" required v-model="alumno.direccion" type="text" class="form-control bg-body-tertiary border-0 shadow-sm text-body">
                                </div>
                            </div>
                            <div class="row mb-3 align-items-center">
                                <label class="col-sm-3 col-form-label fw-semibold text-secondary">EMAIL:</label>
                                <div class="col-sm-9">
                                    <input placeholder="Correo electrónico" required v-model="alumno.email" type="email" class="form-control bg-body-tertiary border-0 shadow-sm text-body">
                                </div>
                            </div>
                            <div class="row mb-4 align-items-center">
                                <label class="col-sm-3 col-form-label fw-semibold text-secondary">TELÉFONO:</label>
                                <div class="col-sm-9 col-md-5">
                                    <input placeholder="Teléfono" required v-model="alumno.telefono" type="text" class="form-control bg-body-tertiary border-0 shadow-sm text-body">
                                </div>
                            </div>
                        </div>
