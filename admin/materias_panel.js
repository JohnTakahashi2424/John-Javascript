...
const materiasAdmin = {
    ...
    template: `
        <div>
            ...
            <div class="d-flex flex-wrap gap-1 mb-3 p-2 bg-light rounded border" style="max-height:320px;overflow-y:auto;">
            ...
            <div v-else class="card border-0 shadow-sm">
                    ...
                    <table class="table table-hover align-middle mb-0 small">
                        <thead class="table-light">
                            <tr>
                                ...
                                <th>Carrera</th>
                                <th>Docente</th>
                                <th style="min-width:150px;">Cupo</th>
                                <th>Estado</th>
                        ...
                        <tbody>
                            <tr v-for="m in materiasFiltradas" :key="m.idMateria"
                                ...
                                <td>{{ m.nombre }}</td>
                                <td><span class="badge bg-light text-dark border">{{ m.carrera || '—' }}</span></td>
                ...
                <div class="card-footer bg-white text-muted small">
                    {{ materiasFiltradas.length }} materias — <span class="text-danger">Solo se puede eliminar si no tienen inscritos</span>
                </div>
            </div>
                        ...
                        <div class="modal-body">
                            <div class="row g-3">
                                <div class="col-5">
                                    ...
                                    <input v-model="form.codigo" class="form-control form-control-sm" placeholder="Ej. MAT-101" required>
                                </div>
                                <div class="col-4">
                                    <label class="form-label small fw-semibold text-muted text-uppercase">Cupo máx.</label>
                                    <input v-model.number="form.cupo" type="number" min="0" class="form-control form-control-sm">
                                </div>
                                <div class="col-3">
                                ...
                                <div class="col-12">
                                    <label class="form-label small fw-semibold text-muted text-uppercase">Nombre *</label>
                                    <input v-model="form.nombre" class="form-control form-control-sm" placeholder="Nombre completo de la materia" required>
                                </div>
                                <div class="col-12">
                                    <label class="form-label small fw-semibold text-muted text-uppercase">Docente asignado</label>
                                ...
                                <div class="col-12">
                                    ...
                                    <select v-model="form.carreraId" class="form-select form-select-sm">
                                        <option value="">— Sin carrera (materia general) —</option>
                                        <option v-for="c in carreras" :key="c.idCarrera" :value="String(c.idCarrera)">
                                            {{ c.nombre }} ({{ c.codigo }})
                                        </option>
                                    </select>
                                    <div class="form-text">Las materias sin carrera serán visibles para todos los alumnos.</div>
                                </div>
                            </div>
                        </div>
